    ...
    <div class="blog_content pt-5">
        <div class="container">
                        ...
                        <div class="card my-0 my-lg-4 mb-4 mb-lg-0">
                            <div class="card-body">
                                ...
                                <div class="user-image">
                                    <img src="<?php echo $webinar_author_image = get_post_meta($post->ID,'webinar_author_image',true);?>">
                                </div>
                                <div class="user-info ml-3 mb-0">
                                     <h6 class="mt-2"><?php echo $webinar_author_name = get_post_meta($post->ID,'webinar_author_name',true);?></h6>
                                    <p><?php echo $webinar_author_desc = get_post_meta($post->ID,'webinar_author_desc',true);?>
                                </p>
                            </div>
								</div>
                        </div>
            ...
            <div class="row mb-5 mt-4 blog_cards ">
               <?php
			$args = array( 'post_type' => 'webinar', 'post__in' => array(300,310,302), );
